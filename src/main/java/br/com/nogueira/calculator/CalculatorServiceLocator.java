...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements br.com.nogueira.calculator.CalculatorService {
    ...
    public br.com.nogueira.calculator.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.nogueira.calculator.CalculatorSoapBindingStub _stub = new br.com.nogueira.calculator.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.nogueira.calculator.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.nogueira.calculator.CalculatorSoapBindingStub _stub = new br.com.nogueira.calculator.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://calculator.nogueira.com.br", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calculator.nogueira.com.br", "Calculator"));
        }
